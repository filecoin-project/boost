...
var lidCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		return fmt.Errorf("not longer implemented")
...
//		}
//
//		if len(info.DeprecatedDealIDs) < 1 {
...
//	logger.Debugw("processing sector", "sector", info.SectorNumber, "deals", info.DeprecatedDealIDs)
//
...
//		if gotErr {
//			logger.Debugw("processed sector with errors", "sector", sectorid, "took", took, "deals", info.DeprecatedDealIDs)
//		} else {
//			logger.Debugw("successfully processed sector", "sector", sectorid, "took", took, "deals", info.DeprecatedDealIDs)
//		}
//	}()
//
...
//
//	nextoffset := uint64(0)
//	for _, did := range info.DeprecatedDealIDs {
