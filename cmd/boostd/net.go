...
func addrInfoFromArg(ctx context.Context, cctx *cli.Context) ([]peer.AddrInfo, error) {
	...
	if err != nil {
		...
		na, fc, err := bcli.GetFullNodeAPI(cctx)
		if err != nil {
			return nil, err
		}
		defer fc()
...
var NetBlockAddPeer = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		return api.NetBlockAdd(ctx, bapi.NetBlockList{Peers: peers})
	},
}
...
var NetBlockAddIP = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		return api.NetBlockAdd(ctx, bapi.NetBlockList{IPAddrs: cctx.Args().Slice()})
	},
}
...
var NetBlockAddSubnet = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		return api.NetBlockAdd(ctx, bapi.NetBlockList{IPSubnets: cctx.Args().Slice()})
	},
}
...
var NetBlockRemovePeer = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		return api.NetBlockRemove(ctx, bapi.NetBlockList{Peers: peers})
	},
}
...
var NetBlockRemoveIP = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		return api.NetBlockRemove(ctx, bapi.NetBlockList{IPAddrs: cctx.Args().Slice()})
	},
}
...
var NetBlockRemoveSubnet = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		return api.NetBlockRemove(ctx, bapi.NetBlockList{IPSubnets: cctx.Args().Slice()})
	},
}
