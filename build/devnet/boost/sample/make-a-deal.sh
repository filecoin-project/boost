...
############################################################\n"
############################################################
printf "\n5. Lets generate a sample file in ${ci}/app/public/sample.txt${cn}. We will use it as a demo file.\n\n"
read -rsp $'Press any key to execute it...\n\n' -n1 key
...
printf "\n6. After that you need to generate a car file for data you want to store on Filecoin (${ci}/app/public/sample.txt${cn}), \
...
############################################################\n"
############################################################
printf "\n7. Then you need to calculate the commp and piece size for the generated car file:\n \
