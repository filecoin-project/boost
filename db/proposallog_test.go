...
func TestProposalLogDB(t *testing.T) {
	...
	req.Equal(d1.ClientDealProposal.Proposal.Provider.String(), logs[2].ProviderAddress.String())
	...
	req.Equal(d2.ClientDealProposal.Proposal.Provider.String(), logs[1].ProviderAddress.String())
	req.Equal(false, logs[1].Accepted)
	req.Equal("reason1", logs[1].Reason)
	req.Equal(d3.DealUUID, logs[0].DealUUID)
	req.Equal(d3.ClientDealProposal.Proposal.Provider.String(), logs[0].ProviderAddress.String())
