...
//go:generate go run github.com/golang/mock/mockgen -destination=./piecestore.go -package=mock github.com/filecoin-project/boost/markets/piecestore PieceStore
