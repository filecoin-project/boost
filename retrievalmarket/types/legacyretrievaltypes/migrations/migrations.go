...
type QueryResponse0 struct {
	Status        legacyretrievaltypes.QueryResponseStatus
	PieceCIDFound legacyretrievaltypes.QueryItemStatus // V1 - if a PieceCID was requested, the result
...
func MigrateQueryParams0To1(oldParams QueryParams0) legacyretrievaltypes.QueryParams {
	return legacyretrievaltypes.QueryParams{
		PieceCID: oldParams.PieceCID,
	}
}

// MigrateQuery0To1 migrates tuple encoded query to map encoded query
func MigrateQuery0To1(oldQuery Query0) legacyretrievaltypes.Query {
	return legacyretrievaltypes.Query{
...
func MigrateQueryResponse0To1(oldQr QueryResponse0) legacyretrievaltypes.QueryResponse {
...
func MigrateDealPayment0To1(oldDp DealPayment0) legacyretrievaltypes.DealPayment {
	return legacyretrievaltypes.DealPayment{
		ID:             oldDp.ID,
...
func MigrateDealProposal0To1(oldDp DealProposal0) legacyretrievaltypes.DealProposal {
...
func MigrateDealResponse0To1(oldDr DealResponse0) legacyretrievaltypes.DealResponse {
	return legacyretrievaltypes.DealResponse{
		Status:      oldDr.Status,
		ID:          oldDr.ID,
...
func MigratePaymentInfo0To1(oldPi *PaymentInfo0) *legacyretrievaltypes.PaymentInfo {
	if oldPi == nil {
		return nil
	}
	return &legacyretrievaltypes.PaymentInfo{
		PayCh: oldPi.PayCh,
		Lane:  oldPi.Lane,
	}
}
...
// initially be nil.
func MigrateClientDealState1To2(oldDs *maptypes.ClientDealState1) (*legacyretrievaltypes.ClientDealState, error) {
	var chid *datatransfer.ChannelID
	if oldDs.ChannelID.Initiator != "" && oldDs.ChannelID.Responder != "" {
		chid = &oldDs.ChannelID
	}
	return &legacyretrievaltypes.ClientDealState{
...
// ChannelID is not set until the data transfer has started, so it should
// initially be nil.
func MigrateProviderDealState1To2(oldDs *maptypes.ProviderDealState1) (*legacyretrievaltypes.ProviderDealState, error) {
	var chid *datatransfer.ChannelID
	if oldDs.ChannelID.Initiator != "" && oldDs.ChannelID.Responder != "" {
		chid = &oldDs.ChannelID
	}
	return &legacyretrievaltypes.ProviderDealState{
		DealProposal:    oldDs.DealProposal,
		StoreID:         oldDs.StoreID,
		ChannelID:       chid,
...
func MigrateAsk0To1(oldAsk *Ask0) (*legacyretrievaltypes.Ask, error) {
	return &legacyretrievaltypes.Ask{
