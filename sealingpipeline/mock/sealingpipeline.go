...
// Source: sealingpipeline.go

// Package mock_sealingpipeline is a generated GoMock package.
package mock_sealingpipeline
...
func (m *MockAPI) SectorsStatus(ctx context.Context, sid abi.SectorNumber, showOnChainInfo bool) (api.SectorInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SectorsStatus", ctx, sid, showOnChainInfo)
...
func (mr *MockAPIMockRecorder) SectorsStatus(ctx, sid, showOnChainInfo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SectorsStatus", reflect.TypeOf((*MockAPI)(nil).SectorsStatus), ctx, sid, showOnChainInfo)
}

// SectorsSummary mocks base method.
func (m *MockAPI) SectorsSummary(ctx context.Context) (map[api.SectorState]int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SectorsSummary", ctx)
...
func (mr *MockAPIMockRecorder) SectorsSummary(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SectorsSummary", reflect.TypeOf((*MockAPI)(nil).SectorsSummary), ctx)
}
