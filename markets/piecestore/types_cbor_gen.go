...
func (t *PieceInfo) MarshalCBOR(w io.Writer) error {
	...
	if _, err := cw.WriteString(string("Deals")); err != nil {
		return err
	}
...
func (t *BlockLocation) MarshalCBOR(w io.Writer) error {
	...
	if _, err := cw.WriteString(string("BlockSize")); err != nil {
		return err
	}
	...
	if _, err := cw.WriteString(string("RelOffset")); err != nil {
		return err
	}
...
func (t *PieceBlockLocation) MarshalCBOR(w io.Writer) error {
	...
	if _, err := cw.WriteString(string("BlockLocation")); err != nil {
		return err
	}
...
func (t *CIDInfo) MarshalCBOR(w io.Writer) error {
	...
	if _, err := cw.WriteString(string("PieceBlockLocations")); err != nil {
		return err
	}
