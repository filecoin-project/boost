...
var (
	...
	//boostd-data
	SuccessAddDealForPieceCount           = stats.Int64("boostddata/success_add_deal_for_piece_count", "Counter of add deal success", stats.UnitDimensionless)
	SuccessAddIndexCount                  = stats.Int64("boostddata/success_add_index_count", "Counter of add index success", stats.UnitDimensionless)
	SuccessIsIndexedCount                 = stats.Int64("boostddata/success_is_indexed_count", "Counter of is indexed success", stats.UnitDimensionless)
	SuccessIsCompleteIndexCount           = stats.Int64("boostddata/success_is_complete_index_count", "Counter of is complete index success", stats.UnitDimensionless)
	SuccessGetIndexCount                  = stats.Int64("boostddata/success_get_index_count", "Counter of get index success", stats.UnitDimensionless)
	SuccessGetOffsetSizeCount             = stats.Int64("boostddata/success_get_offset_size_count", "Counter of get offset size success", stats.UnitDimensionless)
	SuccessListPiecesCount                = stats.Int64("boostddata/success_list_pieces_count", "Counter of list pieces success", stats.UnitDimensionless)
	SuccessPiecesCountCount               = stats.Int64("boostddata/success_piece_count_count", "Counter of piece count success", stats.UnitDimensionless)
	SuccessScanProgressCount              = stats.Int64("boostddata/success_scan_progress_count", "Counter of scan progress success", stats.UnitDimensionless)
	SuccessGetPieceMetadataCount          = stats.Int64("boostddata/success_get_piece_metadata_count", "Counter of get piece metadata success", stats.UnitDimensionless)
	SuccessGetPieceDealsCount             = stats.Int64("boostddata/success_get_piece_deals_count", "Counter of get piece deals success", stats.UnitDimensionless)
	SuccessIndexedAtCount                 = stats.Int64("boostddata/success_indexed_at_count", "Counter of indexed at success", stats.UnitDimensionless)
	SuccessPiecesContainingMultihashCount = stats.Int64("boostddata/success_pieces_containing_multihashes_count", "Counter of pieces containing multihashes success", stats.UnitDimensionless)
	SuccessRemoveDealForPieceCount        = stats.Int64("boostddata/success_remove_deal_for_piece_count", "Counter of remove deal for piece success", stats.UnitDimensionless)
	SuccessRemovePieceMetadataCount       = stats.Int64("boostddata/success_remove_piece_metadata_count", "Counter of remove piece metadata success", stats.UnitDimensionless)
	SuccessRemoveIndexesCount             = stats.Int64("boostddata/success_remove_indexes_count", "Counter of remove indexes success", stats.UnitDimensionless)
	SuccessNextPiecesToCheckCount         = stats.Int64("boostddata/success_next_pieces_to_check_count", "Counter of next pieces to check success", stats.UnitDimensionless)
	SuccessFlagPieceCount                 = stats.Int64("boostddata/success_flag_piece_count", "Counter of flag piece success", stats.UnitDimensionless)
	SuccessUnflagPieceCount               = stats.Int64("boostddata/success_unflag_piece_count", "Counter of unflag piece success", stats.UnitDimensionless)
	SuccessFlaggedPiecesListCount         = stats.Int64("boostddata/success_flagged_pieces_list_count", "Counter of flagged pieces list success", stats.UnitDimensionless)
	SuccessFlaggedPiecesCountCount        = stats.Int64("boostddata/success_flagged_pieces_count_count", "Counter of flagged pieces count success", stats.UnitDimensionless)
	FailureAddDealForPieceCount           = stats.Int64("boostddata/failure_add_deal_for_piece_count", "Counter of add deal failure", stats.UnitDimensionless)
	FailureAddIndexCount                  = stats.Int64("boostddata/failure_add_index_count", "Counter of add index failure", stats.UnitDimensionless)
	FailureIsIndexedCount                 = stats.Int64("boostddata/failure_is_indexed_count", "Counter of is indexed failure", stats.UnitDimensionless)
	FailureIsCompleteIndexCount           = stats.Int64("boostddata/failure_is_complete_index_count", "Counter of is complete index failure", stats.UnitDimensionless)
	FailureGetIndexCount                  = stats.Int64("boostddata/failure_get_index_count", "Counter of get index failure", stats.UnitDimensionless)
	FailureGetOffsetSizeCount             = stats.Int64("boostddata/failure_get_offset_size_count", "Counter of get offset size failure", stats.UnitDimensionless)
	FailureListPiecesCount                = stats.Int64("boostddata/failure_list_pieces_count", "Counter of list pieces failure", stats.UnitDimensionless)
	FailurePiecesCountCount               = stats.Int64("boostddata/failure_piece_count_count", "Counter of piece count failure", stats.UnitDimensionless)
	FailureScanProgressCount              = stats.Int64("boostddata/failure_scan_progress_count", "Counter of scan progress failure", stats.UnitDimensionless)
	FailureGetPieceMetadataCount          = stats.Int64("boostddata/failure_get_piece_metadata_count", "Counter of get piece metadata failure", stats.UnitDimensionless)
	FailureGetPieceDealsCount             = stats.Int64("boostddata/failure_get_piece_deals_count", "Counter of get piece deals failure", stats.UnitDimensionless)
	FailureIndexedAtCount                 = stats.Int64("boostddata/failure_indexed_at_count", "Counter of indexed at failure", stats.UnitDimensionless)
	FailurePiecesContainingMultihashCount = stats.Int64("boostddata/failure_pieces_containing_multihashes_count", "Counter of pieces containing multihashes failure", stats.UnitDimensionless)
	FailureRemoveDealForPieceCount        = stats.Int64("boostddata/failure_remove_deal_for_piece_count", "Counter of remove deal for piece failure", stats.UnitDimensionless)
	FailureRemovePieceMetadataCount       = stats.Int64("boostddata/failure_remove_piece_metadata_count", "Counter of remove piece metadata failure", stats.UnitDimensionless)
	FailureRemoveIndexesCount             = stats.Int64("boostddata/failure_remove_indexes_count", "Counter of remove indexes failure", stats.UnitDimensionless)
	FailureNextPiecesToCheckCount         = stats.Int64("boostddata/failure_next_pieces_to_check_count", "Counter of next pieces to check failure", stats.UnitDimensionless)
	FailureFlagPieceCount                 = stats.Int64("boostddata/failure_flag_piece_count", "Counter of flag piece failure", stats.UnitDimensionless)
	FailureUnflagPieceCount               = stats.Int64("boostddata/failure_unflag_piece_count", "Counter of unflag piece failure", stats.UnitDimensionless)
	FailureFlaggedPiecesListCount         = stats.Int64("boostddata/failure_flagged_pieces_list_count", "Counter of flagged pieces list failure", stats.UnitDimensionless)
	FailureFlaggedPiecesCountCount        = stats.Int64("boostddata/failure_flagged_pieces_count_count", "Counter of flagged pieces count failure", stats.UnitDimensionless)
)
