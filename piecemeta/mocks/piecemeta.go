...
// Source: github.com/filecoin-project/boost/piecemeta (interfaces: SectionReader,Sealer,Store)
...
func (m *MockSealer) GetReader(arg0 context.Context, arg1 abi.SectorNumber, arg2, arg3 abi.PaddedPieceSize) (piecemeta.SectionReader, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSealerMockRecorder) GetReader(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReader", reflect.TypeOf((*MockSealer)(nil).GetReader), arg0, arg1, arg2, arg3)
}
