...
// Source: github.com/filecoin-project/boost/piecemeta (interfaces: SectionReader,PieceReader,Store)
...
func (m *MockPieceReader) GetReader(arg0 context.Context, arg1 abi.SectorNumber, arg2, arg3 abi.PaddedPieceSize) (piecemeta.SectionReader, error) {
	m.ctrl.T.Helper()
