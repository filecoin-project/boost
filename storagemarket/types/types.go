...
type StorageProviderNode interface {
	...
	PublishDeals(ctx context.Context, deal ProviderDealState) (cid.Cid, error)
	...
	OnDealComplete(ctx context.Context, deal ProviderDealState, pieceSize abi.UnpaddedPieceSize, pieceReader io.Reader) (*PackingResult, error)
