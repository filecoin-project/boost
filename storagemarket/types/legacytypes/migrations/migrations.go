...
type MinerDeal0 struct {
	...
	Miner                 peer.ID
	Client                peer.ID
	State                 legacytypes.StorageDealStatus
...
func MigrateDataRef0To1(oldDr *DataRef0) *legacytypes.DataRef {
	if oldDr == nil {
		return nil
	}
	return &legacytypes.DataRef{
...
func MigrateClientDeal0To1(oldCd *ClientDeal0) (*legacytypes.ClientDeal, error) {
	return &legacytypes.ClientDeal{
...
func MigrateMinerDeal1To2(oldCd *MinerDeal1) (*legacytypes.MinerDeal, error) {
...
func MigrateClientDealProposal0To1(prop marketOld.ClientDealProposal) (*legacytypes.ClientDealProposal, error) {
	...
	return &legacytypes.ClientDealProposal{
...
func MigrateStorageAsk0To1(oldSa *StorageAsk0) *legacytypes.StorageAsk {
...
func GetMigrateSignedStorageAsk0To1(sign func(ctx context.Context, ask *legacytypes.StorageAsk) (*crypto.Signature, error)) func(*SignedStorageAsk0) (*legacytypes.SignedStorageAsk, error) {
	return func(oldSsa *SignedStorageAsk0) (*legacytypes.SignedStorageAsk, error) {
