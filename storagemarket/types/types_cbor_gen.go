...
func (t *DealParams) MarshalCBOR(w io.Writer) error {
	...
	// t.MinerPeerID (peer.ID) (string)
	if len("MinerPeerID") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"MinerPeerID\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("MinerPeerID"))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string("MinerPeerID")); err != nil {
		return err
	}

	if len(t.MinerPeerID) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.MinerPeerID was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.MinerPeerID))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.MinerPeerID)); err != nil {
		return err
	}

	// t.ClientPeerID (peer.ID) (string)
	if len("ClientPeerID") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"ClientPeerID\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("ClientPeerID"))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string("ClientPeerID")); err != nil {
		return err
	}

	if len(t.ClientPeerID) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.ClientPeerID was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.ClientPeerID))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.ClientPeerID)); err != nil {
		return err
	}
